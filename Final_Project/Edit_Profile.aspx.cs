...
namespace Final_Project
{
    public partial class Edit_Profile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = ad.GetData("Select * from tblInsured" );
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            int i = cn.GetData("update tblinsured set occupation='" + TextBox1.Text + "',block ='" + TextBox2.Text + "',village='" + TextBox3.Text + "',district='" + TextBox4.Text + "',state='" + TextBox5.Text + "',pin='" + TextBox6.Text + "',nomineename='" + TextBox7.Text + "',nomineerelation='" + TextBox8.Text + "',nomineeage='" + TextBox9.Text + "' where insuredid=102");
